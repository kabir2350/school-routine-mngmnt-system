...
def search_routine(request):
    ...
    if request.method == 'GET':
        ...
        monday_classes = all_classes.filter(day__name__icontains="Monday").order_by('timing__time')
        tuesday_classes = all_classes.filter(day__name__icontains="Tuesday").order_by('timing__time')
        wednesday_classes = all_classes.filter(day__name__icontains="Wednesday").order_by('timing__time')
        thursday_classes = all_classes.filter(day__name__icontains="Thursday").order_by('timing__time')
        friday_classes = all_classes.filter(day__name__icontains="Friday").order_by('timing__time')
        saturday_classes = all_classes.filter(day__name__icontains="Saturday").order_by('timing__time')
        context = {
            'all_depts': all_depts,
            'searched_classes': all_depts,
